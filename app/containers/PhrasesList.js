...
import {
  getData, getUserId, getDataLoading, getOffline, getAudioCache, getCurrentDictionaryName
} from 'app/reducers/selectors'
import styles from 'app/styles'
import { store } from 'app/redux'
import colors from 'app/styles/colors'
import {
  PLAY_PHRASE, OPEN_ADD_NEW_MODAL, SHARE_PHRASE, SHARE_ALL_PHRASES, SHARE_DICTIONARY, OPEN_PHRASE
      ...
      ListEmptyComponent={(
        ...
        >
          ...
          <Text style={styles.flatlistPlaceholder}>
            {data_loading ? 'Loading...' : 'Add your first phrazee!'}
          </Text>
        </View>
      )}
      ListFooterComponent={(
